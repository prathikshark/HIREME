...
ActiveRecord::Schema[7.1].define(version: 2024_05_08_070752) do
  ...
  create_table "booked_services", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "worker_skills", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.text "experience"
    t.integer "wage"
    t.float "rating"
